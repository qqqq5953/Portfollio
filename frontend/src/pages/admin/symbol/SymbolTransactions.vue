...
const isHistroyLoading = ref(true);
      ...
      <div class="grid grid-cols-2 gap-4">
        <Card>
          <CardContent>
            ...
            <div v-if="isHistroyLoading" class="flex justify-center items-center pt-2">
      ...
      <CardContent>
        ...
        >
          ...
          <TabsContent value="buy" class="flex flex-col gap-4 mt-4">
            <div v-if="isHistroyLoading" class="space-y-8">
              <div class="space-y-4">
